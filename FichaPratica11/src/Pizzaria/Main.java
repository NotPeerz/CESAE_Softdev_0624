...
public class Main {
    public static void main(String[] args) {
        ...
        Ingrediente ingrediente1 = new Ingrediente("Ingrediente1",19922,"Massa Alta", unidadeMedidaIngrediente.Gramas,1.5);
        Ingrediente ingrediente2 = new Ingrediente("Ingrediente2",13476,"Queijo de Cabra",unidadeMedidaIngrediente.Gramas,2.8);
        Ingrediente ingrediente3 = new Ingrediente("Ingrediente3",14445,"Rodela Chouriça de Mirandela",unidadeMedidaIngrediente.Unidades,35);
        Ingrediente ingrediente4 = new Ingrediente("Ingrediente4",10015,"Molho Tomate",unidadeMedidaIngrediente.Litros,325);
        Ingrediente ingrediente5 = new Ingrediente("Ingrediente5",10900,"Fatia Pimento Verde",unidadeMedidaIngrediente.Unidades,4);
